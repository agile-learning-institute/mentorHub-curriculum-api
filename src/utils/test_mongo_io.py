...
class TestMongoIO(unittest.TestCase):
    ...
    def setUp(self):
        # Breadcrumb object (matches database)
    ...
    def test_get_some_topics(self):
        mongo_io = MongoIO.get_instance()
        topics = mongo_io.get_topics("data")
        self.assertEqual(len(topics), 4)

    def test_get_a_topic(self):
        mongo_io = MongoIO.get_instance()
        topic = mongo_io.get_topic("aaaa00000000000000000002")
        expected = {"name":"History of Computing","resources":[{"name":"ComputerHistoryTimelineA","description":"Computer History Timeline Article","link":"https://somevalidlink02.com","skills":["Some Skill with little info","Vue.js concepts with design system libraries"],"tags":["$","Article","Exam","Interactive","Lesson","Tutorial","Video","Data"]},{"name":"HistoryofComputingArticl","description":"History of Computing Article","link":"https://somevalidlink03.com","skills":["Some Skill with little info","Python Data Structures and with Pandas"],"tags":["Article","Book","Reference","User Guide","API","Data"]},{"name":"PiratesofSiliconValleyFi","description":"Pirates of Silicon Valley Film","link":"https://somevalidlink04.com","skills":["Some Skill with little info","Python Data Structures and with Pandas"],"tags":["Exam","Lecture","Video","API","Data"]},{"name":"Apple1984SuperBowlCommer","description":"Apple 1984 Super Bowl Commercial Video","link":"https://somevalidlink05.com","skills":["Some Skill with little info","Python Data Structures and with Pandas"],"tags":["Article","Book","Interactive","Lecture","Lesson","User Guide","UI/UX","API","Data"]},{"name":"BretVictorTheFutureofPro","description":"Bret Victor The Future of Programming Video","link":"https://somevalidlink06.com","skills":["Basic use of the Unix/Linux command line and shell scripts"],"tags":["Lecture","Lesson","Tutorial","User Guide","Video","API","Data"]},{"name":"AwesomeComputerHistoryRe","description":"Awesome Computer History Resource","link":"https://somevalidlink07.com","skills":["Vue.js concepts with design system libraries"],"tags":["Book","Lecture","Reference","User Guide","Video","UI/UX","Data"]},{"name":"JeanBartikandtheENIACWom","description":"Jean Bartik and the ENIAC Women Video","link":"https://somevalidlink08.com","skills":["Some Skill with little info","Python Data Structures and with Pandas"],"tags":["Article","Exam","Interactive","Lecture","Tutorial","User Guide","UI/UX","API","Data"]}]}
        self.assertEqual(topic, expected)

    def test_get_curriculum(self): 
        mongo_io = MongoIO.get_instance()
        curriculum = mongo_io.get_curriculum("aaaa00000000000000000001")
        completed = [{"name":"JeanBartikandtheENIACWom","link":"https://somevalidlink08.com","description":"The Description String","skills":["skill_A","skill_B"],"tags":["Article","Book"],"started":datetime.fromisoformat("2024-07-01T13:00:00"),"completed":datetime.fromisoformat("2024-07-01T14:30:00"),"rating":4,"review":"This was a great intro"}, {"name":"Markdown Tutorial","link":"https://www.markdowntutorial.com/lesson/1/","description":"The Description String","skills":["skil_C","skill_D"],"tags":["User Guide", "Interactive"],"started":datetime.fromisoformat("2024-07-02T13:00:00"),"completed":datetime.fromisoformat("2024-07-03T19:36:00"),"rating":3,"review":"I had to read this twice before it made sense"}]
        now = [{"name":"AWSStorageResource","link":"https://somevalidlink.35.com","description":"The Description String", "skills": ["skil-A", "skill-B"], "tags": ["Reference", "Data"],"started":datetime.fromisoformat("2024-07-15T13:00:00")},{"name":"Some Unique Resource","description":"The Description String", "skills": ["skil-C", "skill-D"], "tags": ["Video", "Exam"],"link":"https://some.com/resource"}]
        next = [{"path":"The Odin Project","segments":[{"segment":"Intermediate HTML and CSS","topics":[{"topic":"Intermediate HTML","resources":[{"name":"Howdocomputersreadcode?V","link":"https://somevalidlink.22.com","description":"The Description String", "skills": ["skil1", "skill2"], "tags": ["Lesson", "Tutorial"]},{"name":"A one-off resource","link":"https://some.com/resource","description":"The Description String", "skills": ["skil3", "skill4"], "tags": ["Reference", "Data"]}]}]}]}]
        ...
        expected = {"_id":ObjectId("aaaa00000000000000000001"),"completed":completed,"now":now,"next":next,"later":later,"lastSaved":self.breadcrumb}
